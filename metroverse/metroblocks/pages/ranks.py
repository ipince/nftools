...
def ranks():
    ...
    body += f"""<tr>
    <th>Block Name</th>
    <th>Staked?<br><small>as of {mv.last_stake_update()}</small></th>
    <th>Score (unboosted)</th>
    <th>Rank (of unboosted score)</th>
    <th>Boost (pct)</th><th>Score (boosted)</th>
    <th style='background: darkseagreen'>Rank (of boosted score)</th>
    </tr>
    """
